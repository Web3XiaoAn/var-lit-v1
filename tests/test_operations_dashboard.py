...
class OperationsDashboardServerTests(unittest.TestCase):
    ...
    def test_dashboard_has_no_external_assets_or_popup_controls(self) -> None:
        ...
        self.assertNotIn("basis-actual-", source)
        self.assertNotIn("500U开仓", source)
        self.assertIn("currentBasis.fresh", source)
        self.assertIn("openThresholds.fresh", source)
        self.assertIn("最新已知", source)
